...
import { PlumberIcon, HairCutIcon, TailorIcon, ExploreIcon, HistoryIcon, ChatIcon, } from '../Assets';
            ...
            <View style={styles.container}>
                ...
                <View style={styles.categoryContainer}>
                    <View style={styles.tagContainer}>
                        ...
                        >
                            {categories.map((items, i) => <Tags
                                key={i}
                                style={selected == items.id ? { backgroundColor: colors.default } : null}
                            >
                                <TouchableOpacity
